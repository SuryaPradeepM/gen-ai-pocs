...
class GlobalState extends Component {
    ...
    render() {
        ...
        const {  templateList,userDetails,selectedBotOnHome,workspaceScreenNumber,workspaceId, heading,workSpaceDetails,registryScreenNumber, createLabel,selectedDataSourceId, docIndexMap, sectionLabels, isUploadTemplate, headerAvailable, selectedChunkValues } = this.state;
        const {  setTemplateList, setHeading,setSelectedBotOnHome,setWorkspaceScreenNumber ,setWorkspaceId, setWorkSpaceDetails, setCreateLabel, setSelectedDataSourceId,setDocIndexMap, setSectionLabels, setIsUploadTemplate, setRegistryScreenNumber, setHeaderAvailable, setSelectedChunks } = this
        return (
            <GenAIContext.Provider value={{
                userDetails,
                workSpaceDetails,
                createLabel,
