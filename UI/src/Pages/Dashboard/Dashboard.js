          ...
          <Box id="discoverPOC" className={classes.discoverPOCContainer}>
            <Box className={classes.discoverPOCTopContainer}>
              <Box className={classes.discoverPOCDes}>
                <Typography className={classes.pocExplorationContentHeading1}>
                  Discover Generative AI Playzone
                </Typography>
                <Typography
              ...
              <Box id="cardContainer" className={classes.discoverPOCCards}>
                ...
                >
                  ...
                  <Box className={classes.cardBody}>
                    ...
                    >
                      Discover the future of content Presentation with our
                      Virtual Presenter, offering content presentation .
                    </Typography>
                  </Box>
                </Card>
                ...
                <Card
                  onClick={() => {
                    isServiceAvailable("meeting_summary") &&
                      navigate("/meeting_summary");
                  }}
                  className={`${classes.cardContainer} ${!isServiceAvailable("meeting_summary") && classes.disabledCard}`}
                >
                  <IconButton
                    title="Go To Meeting Summaries"
                    className={classes.gotoPOCBtn}
                    onClick={() => {
                      navigate("/meeting_summary");
                    }}
                  ...
                  <Box className={classes.cardBody}>
                    ...
                    <Typography
                      ...
                      color="text.secondary"
                    >
                      Introducing an innovative application that compiles
                      detailed meeting minutes, capturing attendance and
                      discussions for comprehensive documentation.
                    </Typography>
                  </Box>
                </Card>
                ...
                >
                  ...
                  <Box className={classes.cardBody}>
                    ...
                    <Typography
                      ...
                      color="text.secondary"
                    >
                      Create unique and professional logos with our AI-powered
                      Logo Generator, offering customizable designs for your
                ...
                <Card
                  onClick={() => {
                    isServiceAvailable("rag_chatbot") &&
                      navigate("/rag-chatbot");
                  }}
