...
function Summary(props) {
  ...
  const [classifiedInputValue, setClassifiedInputValue] =
    useState(`Create a concise summary. The document might contain complex medical information and terminology.
  ...
  const handleSubmitDocumentClassification = async () => {
    ...
    if (getDocClassificationInfo && getDocClassificationInfo.status === 200) {
      setDocumentClassificationResponseData(
        getDocClassificationInfo.data.summary,
      );
  ...
  const downloadPDF = () => {
    ...
    html2pdf().from(contentElement).save("Summery using GPT4 (Experiment).pdf");
  };
      ...
      <Scrollbars>
        ...
        <Grid item className={classes.mainContent}>
          ...
          >
            ...
            />{" "}
            Document Summarization using GPT 4 (Experiment){" "}
          </Typography>
            ...
            <Grid item xs={4}>
                ...
                <Grid item className={classes.attachedTop}>
                  <Grid item className={classes.labelBox}>
                    <Typography variant="body1">
                      Attach Input PDF document<sup>*</sup>
                    </Typography>
                  </Grid>
              ...
              <Grid item className={classes.formBlock}>
                <Grid
                  container
                  spacing={2}
                  className={classes.formDropWrapper}
                ></Grid>
                <LoadingButton
                  disableRipple
